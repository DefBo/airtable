...
function parse(e){var t=[].slice.call(arguments,1),n=0;return e.replace(/%s/g,function(){return t[n++]})}$(function(){$(document).ready(function(){$("tbody tr").each(function(e,t){$(this).children(":first").addClass("position-fixed-x")}),$("thead tr").children(":first").addClass("position-fixed-x")})}),$(window).scroll(function(){$w=$(window),$(".position-fixed-x").css("left",$w.scrollLeft())}),$(".textarea-cell").focus(function(){$(this).addClass("editable"),$(this).children("span").each(function(e,t){$(this).contents().unwrap().wrap("<div></div>")}),$(this).children("span").each(function(e,t){$(this).replaceWith("<br>")})}),$(".textarea-cell").blur(function(){$(this).children("div").each(function(e,t){$(this).children("br").remove(),0===$(this).text().length?$(this).remove():($(this).children("div").unwrap(),$(this).contents().unwrap().wrap("<span></span>"))}),$(this).children("div").each(function(e,t){$(this).contents().unwrap().wrap("<span></span>")}),$(this).children("br").each(function(e,t){$(this).replaceWith("<span></span>")}),$(this).removeClass("editable")}),$(".selectpicker").selectpicker(),$("#filter-link").on("click",function(e){$(".dropdown-menu-filter").toggleClass("show")}),$("body").on("click",function(e){$(".dropdown-menu-filter").is(e.target)||$("#filter-link").is(e.target)||$("#filter-link>i").is(e.target)||0!==$(".dropdown-menu-filter").has(e.target).length||0!==$(".dropdown-menu-filter.show").has(e.target).length||$(".dropdown-menu-filter").removeClass("show")}),$("#hide-link").on("click",function(e){$(".dropdown-menu-hide").toggleClass("show")}),$("body").on("click",function(e){$(".dropdown-menu-hide").is(e.target)||$("#hide-link").is(e.target)||$("#hide-link>i").is(e.target)||0!==$(".dropdown-menu-hide").has(e.target).length||0!==$(".dropdown-menu-hide.show").has(e.target).length||$(".dropdown-menu-hide").removeClass("show")}),$("#view-link").on("click",function(e){$(".dropdown-menu-view").toggleClass("show")}),$("body").on("click",function(e){$(".dropdown-menu-view").is(e.target)||$("#view-link").is(e.target)||$("#view-link>i").is(e.target)||$("#view-link>span").is(e.target)||0!==$(".dropdown-menu-view").has(e.target).length||0!==$(".dropdown-menu-view.show").has(e.target).length||$(".dropdown-menu-view").removeClass("show")}),$("#search-link").on("click",function(e){$(".dropdown-menu-search").toggleClass("show")}),$("body").on("click",function(e){$(".dropdown-menu-search").is(e.target)||$("#search-link").is(e.target)||$("#search-link>i").is(e.target)||0!==$(".dropdown-menu-search").has(e.target).length||0!==$(".dropdown-menu-search.show").has(e.target).length||$(".dropdown-menu-search").removeClass("show")}),$("#context-tab-link").on("click",function(e){$(".dropdown-menu-subtab").toggleClass("show")}),$("body").on("click",function(e){$(".dropdown-menu-subtab").is(e.target)||$("#context-tab-link").is(e.target)||0!==$(".dropdown-menu-subtab").has(e.target).length||0!==$(".dropdown-menu-subtab.show").has(e.target).length||$(".dropdown-menu-subtab").removeClass("show")}),$("#more-link").on("click",function(e){$(".dropdown-menu-more").toggleClass("show")}),$("body").on("click",function(e){$(".dropdown-menu-more").is(e.target)||$("#more-link").is(e.target)||$("#more-link>i").is(e.target)||0!==$(".dropdown-menu-more").has(e.target).length||0!==$(".dropdown-menu-more.show").has(e.target).length||$(".dropdown-menu-more").removeClass("show")}),$(document).ready(function(){$("#rename-table-btn").click(function(){$("#first-tab-name").hide(),$("#first-tab-input").show(),$("#first-tab-input").select(),$(".dropdown-menu-subtab").removeClass("show")}),$("#first-tab-input").blur(function(){""==$.trim(this.value)?this.value=this.defaultValue?this.defaultValue:"":$("#first-tab-name").html(this.value),$("#first-tab-input").hide(),$("#first-tab-name").show()}),$("#first-tab-input").keypress(function(e){"13"==e.keyCode&&(""==$.trim(this.value)?this.value=this.defaultValue?this.defaultValue:"":$("#first-tab-name").html(this.value),$("#first-tab-input").hide(),$("#first-tab-name").show())})}),$(document).ready(function(){$("#rename-view-btn").click(function(){$(".tab-content__header-link--title").hide(),$(".view-input").show(),$(".view-input").select(),$(".dropdown-menu-more").removeClass("show")}),$(".view-input").blur(function(){""==$.trim(this.value)?this.value=this.defaultValue?this.defaultValue:"":($(".tab-content__header-link--title").html(this.value),$(".view-subtitle").html(this.value)),$(".view-input").hide(),$(".tab-content__header-link--title").show()}),$(".view-input").keypress(function(e){"13"==e.keyCode&&(""==$.trim(this.value)?this.value=this.defaultValue?this.defaultValue:"":($(".tab-content__header-link--title").html(this.value),$(".view-subtitle").html(this.value)),$(".view-input").hide(),$(".tab-content__header-link--title").show())})}),$(function(){$.contextMenu({selector:"td",className:"context-menu-td",items:{"Insert record above":{name:"Insert record above",icon:"fas fa-long-arrow-alt-up"},"Insert record below":{name:"Insert record below",icon:"fas fa-long-arrow-alt-down"},"Duplicate record":{name:"Duplicate record",icon:"fas fa-copy"},"Expand record":{name:"Expand record",icon:"fas fa-expand"},"Copy record URL":{name:"Copy record URL",icon:"fas fa-clipboard-list"},"Send record...":{name:"Send record...",icon:"fas fa-envelope"},"Delete record":{name:"Delete record",icon:"fas fa-trash"}}}),$(".context-menu-one").on("click",function(e){console.log("clicked",this)})}),$("th").blur(function(){$(this).attr("contenteditable",!1)}),$(function(){$.contextMenu({selector:"th",className:"context-menu-th",items:{"Customize field type":{name:"Customize field type",icon:"fas fa-cogs"},"Rename field":{name:"Rename field",icon:"fas fa-pencil-alt"},"Edit description":{name:"Edit description",icon:"fas fa-info-circle"},"Duplicate field":{name:"Duplicate field",icon:"fas fa-copy"},"Insert left":{name:"Insert left",icon:"fas fa-long-arrow-alt-left"},"Insert right":{name:"Insert right",icon:"fas fa-long-arrow-alt-right"},"Sort A - Z":{name:"Sort A - Z",icon:"fas fa-sort-alpha-down"},"Sort Z - A":{name:"Sort Z - A",icon:"fas fa-sort-alpha-up"},"Add filter":{name:"Add filter",icon:"fas fa-align-center"},"Group by this field":{name:"Group by this field",icon:"fas fa-clipboard-list"},"Hide field":{name:"Hide field",icon:"fas fa-eye-slash"},"Delete field":{name:"Delete field",icon:"fas fa-trash"}},callback:function(e,t){"Rename field"===e&&t.$trigger.attr("contentEditable",!0).focus()}}),$(".context-menu-one").on("click",function(e){console.log("clicked",this)})}),$(".sortable").sortable(),$(document).ready(function(){$("#field1").change(function(){this.checked?$(".field1-col").show("fade"):$(".field1-col").hide("fade")})}),$(document).ready(function(){$("#field2").change(function(){this.checked?$(".field2-col").show("fade"):$(".field2-col").hide("fade")})}),$(document).ready(function(){$("#field3").change(function(){this.checked?$(".field3-col").show("fade"):$(".field3-col").hide("fade")})}),$(document).ready(function(){$("#field4").change(function(){this.checked?$(".field4-col").show("fade"):$(".field4-col").hide("fade")})}),$(document).ready(function(){$("#field5").change(function(){this.checked?$(".field5-col").show("fade"):$(".field5-col").hide("fade")})}),$(document).ready(function(){$("#field6").change(function(){this.checked?$(".field6-col").show("fade"):$(".field6-col").hide("fade")})}),$(document).ready(function(){$("#field7").change(function(){this.checked?$(".field7-col").show("fade"):$(".field7-col").hide("fade")})}),$(document).ready(function(){$("#field8").change(function(){this.checked?$(".field8-col").show("fade"):$(".field8-col").hide("fade")})}),$(document).ready(function(){$("#field9").change(function(){this.checked?$(".field9-col").show("fade"):$(".field9-col").hide("fade")})}),$(".menuhide-hideall-btn").on("click",function(){$(".fields-to-hide_check").prop("checked",!1),$(".field1-col").hide(""),$(".field2-col").hide(""),$(".field3-col").hide(""),$(".field4-col").hide(""),$(".field5-col").hide(""),$(".field6-col").hide(""),$(".field7-col").hide(""),$(".field8-col").hide(""),$(".field9-col").hide("")}),$(".menuhide-showall-btn").on("click",function(){$(".fields-to-hide_check").prop("checked",!0),$(".field1-col").show(""),$(".field2-col").show(""),$(".field3-col").show(""),$(".field4-col").show(""),$(".field5-col").show(""),$(".field6-col").show(""),$(".field7-col").show(""),$(".field8-col").show(""),$(".field9-col").show("")}),$(window).scroll(function(){$(".fixed-thead").css("top",$(this).scrollTop()+"px")}),$("#nav-partner-tab").click(function(){$("#myTabContent").hide(),$("#first-tab-body").hide()}),$("#nav-opport-tab").click(function(){$("#myTabContent").show(),$("#first-tab-body").show()}),$("#sort-link").on("click",function(e){$(".dropdown-menu-sort").toggleClass("show")}),$("body").on("click",function(e){$(".dropdown-menu-sort").is(e.target)||$("#sort-link").is(e.target)||$("#sort-link>i").is(e.target)||0!==$(".dropdown-menu-sort").has(e.target).length||0!==$(".dropdown-menu-sort.show").has(e.target).length||$(".dropdown-menu-sort").removeClass("show")}),function(){var s,c,r,h;Array.prototype.forEach.call(document.querySelectorAll("table th"),function(a){a.style.position="relative";var d=$(a).outerWidth(),e=document.createElement("div");$(e).addClass("resizer"),e.innerHTML="&nbsp;",e.style.top=0,e.style.right=0,e.style.bottom=0,e.style.width="5px",e.style.position="absolute",e.style.cursor="col-resize",e.addEventListener("mousedown",function(e){for(var t,n=e.target.parentElement.className.split(/\s+/),i=0;i<e.target.parentElement.parentElement.childNodes.length;i++)for(var o=0;o<n.length;o++)(void 0!==e.target.parentElement.parentElement.childNodes[i].className?e.target.parentElement.parentElement.childNodes[i].className.split(/\s+/):"")[o]==n[o]&&(t=n[0]);var l=parse("table tr td.%s",t);h=document.querySelectorAll(l),c=h,r=(s=a).offsetWidth-e.pageX,document.addEventListener("mousemove",function(e){if(s&&$(s).outerWidth()>=d){e.preventDefault();var n=r+e.pageX;n=d<=n?n:d,s.style.minWidth=n+"px",$(c).each(function(e,t){t.style.minWidth=n+"px",t.style.maxWidth=n+"px"})}else{if(void 0===s)return;e.preventDefault(),s.style.minWidth=d+"px",$(c).each(function(e,t){t.style.minWidth=d+"px"})}})}),a.appendChild(e)}),document.addEventListener("mouseup",function(){c=s=void 0})}();