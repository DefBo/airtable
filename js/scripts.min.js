...
$(".textarea-cell").click(function(){$(this).addClass("editable"),$(".textarea-cell").not(this).removeClass("editable")}),$(function(){$(document).on("click",function(e){!1===$(e.target).is(".textarea-cell")&&$(".textarea-cell").removeClass("editable")})}),$(".selectpicker").selectpicker(),$(".dropdown-menu-search").bind("click",function(e){e.stopPropagation()}),$(".dropdown-menu-view").bind("click",function(e){e.stopPropagation()}),$(".dropdown-menu-filter").bind("click",function(e){e.stopPropagation()});